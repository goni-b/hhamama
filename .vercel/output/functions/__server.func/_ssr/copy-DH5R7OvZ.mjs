//#region node_modules/.nitro/vite/services/ssr/assets/copy-DH5R7OvZ.js
var copy = {
...
function greetingKey(hour = (/* @__PURE__ */ new Date()).getHours()) {
...
//#endregion
export { greetingKey as n, t as r, copy as t };
