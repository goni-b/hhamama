  ...
  head: () => ({
    meta: [
      ...
      { title: "HOFIT & GONI — אקדמיית קורסים" },
      {
        name: "description",
        content:
          "HOFIT & GONI — פורטל למידה פרימיום לקורסים דיגיטליים, מבחנים ומשימות. עברית, ממשק כהה, חוויית לימוד ממוקדת.",
      },
      { property: "og:title", content: "HOFIT & GONI — אקדמיית קורסים" },
      {
      ...
      <DirectionProvider dir="rtl">
        ...
        <Toaster
          ...
          toastOptions={{
            classNames: {
              toast:
                "!bg-panel-2 !border !border-line !rounded-[12px] !text-ink !shadow-[var(--elev-2)] !font-sans",
